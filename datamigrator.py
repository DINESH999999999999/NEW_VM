...
if __name__ == "__main__":
    ...
    query="""SELECT TD_DATABASE_NAME,TD_TABLE_NAME,SF_DATABASE_NAME,SF_SCHEMA_NAME,SF_TABLE_NAME,WAREHOUSE_NAME,SCD_TYPE,LOAD_TYPE,CDC_COLUMNS,PRIMARY_KEY,DELIMITER,FILTER_CONDITION,
            TRIM,ENCRYPTION_COLUMNS,S3_PATH,(SELECT COALESCE((SELECT MAX(BATCH_ID) FROM DATAMIGRATION.DEMO_USER.LOG_TABLE)+1,10000)) AS BATCH_ID,JOB_ID,CUSTOM_SQL,EXECUTION_MODE FROM DATAMIGRATION.DEMO_USER.CONFIG_TABLE WHERE ENABLED = 'Y';"""
